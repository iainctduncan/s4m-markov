...
(post "loading bell-comp-ji-harm.scm - JI harmony sketch pad")
...
(s1 'set :step-dur 160 :amp 0.0 :amp-unit 0.1 :pitch-change :all :base-ratio 1/1  
  :beat-seq     #(1   1   1   1  )
  :amp-seq      '(1   1   1   1  )
  :amp-seq      '(0   1   0   1  )
  :root         '(1/1)
  :pitch-seq    '((1) (9/7) (4/3) (7/4))  ; lines up with pattern
)

;(s1 'add-process (lambda ($ %) 
;  (set! ($ :amp-seq 0) (+ ($ :amp-seq 0) .05))
...
(s2 'set :step-dur 160  :amp 0.0 :amp-unit 0.2 :delay 160 :pitch-change :all :base-ratio 1/1  
...
(s6 'set :step-dur 160  :amp 0.1 :amp-unit 0.2 :delay 320 :pitch-change :all :base-ratio 1/1  
  :change-seq   '(1   0   1   0   1   0   0)
  :beat-seq     #(1   2   2   1   2   2   2)
  :amp-seq      '(1 3 2 3)
  :root         '(1/1)
...
(s7 'set :step-dur 160  :amp 0.1 :amp-unit 0.2  :delay 160 :pitch-change :seq  :ref-cps 55 :base-ratio 2/1
  :beat-seq     #(1 1 1 1)
  :change-seq   #(1   1   1   1)
  :amp-seq    '(1 1)
  :root         '(9/7)
...
(s8 'set :step-dur 160  :amp 0.1 :amp-unit 0.2  :delay 160 :pitch-change :seq :ref-cps 55  :base-ratio 2/1
  :beat-seq     #(3   2   3   2   2)
  :change-seq   #(1   1   0   1  0 )
  :amp-seq '(3 2)
  :root         '(1)
