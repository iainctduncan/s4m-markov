...
(define score (make-score (hash-table :bbt '(8 4 480) :res 2 :name "Bell Score-1") `(
  ...
  :5-1    ((post "5-1 chord B")
           (s1 'set :root '(1) 
              :pitch-seq '((7/8 1) (1 4/3) (7/8 7/6)))
           (s4 'set :root '(7/8))
          )

  :9-1    ((post "9-1 s2 to 3, extra bass")
           (s1 'set :root '(1) :base-ratio 1/1 :pitch-change :seq
              :change-seq '(0  1  0  0  1  0  1)  
              :pitch-seq '((1) (4/3) (8/7))) 
  ...
  :13-1   ((post "13-1 chord B")
           (s1 'set :root '(7/8) 
              :pitch-seq '((1) (3/2) (7/6)))
           (s2 'set :root '(7/8) :base-ratio 1/1      ;2
              :pitch-seq '((9/8) (8/7 2) (4/3)))
           (s4 'set :root '(7/8))
          )

  :17-1   ((post "17-1 chord A s1 to 4 notes ") 
           (s1 'set :root '(1) :base-ratio 1/1 :pitch-change :seq
  ...
  :21-1  ((post "21-1 B ")
           (s1 'set :root '(7/8) 
              :pitch-seq '((1) (3/2) (7/6) (4/3)))
           (s2 'set :root '(7/8) :base-ratio 1/1      ;2
              :pitch-seq '((9/8) (8/7 2) (4/3)))
           (s4 'set :root '(7/8)
             :pitch-seq '((1) (1/2) (9/4) (3/2 1/2) (9/7 7/4))) 
           (s7 'set :root '(7/8) 
              :pitch-seq  '((2) (7/4)))
         )

  ; here
  :25-1   ((post "25-1 A s2 to 4") 
           (s1 'set :root '(1) :base-ratio 1/1 :pitch-change :seq
  ...
  :29-1   ((post "29 B:")
           (s1 'set :root '(7/8) 
              :pitch-seq '((1) (3/2) (7/6) (4/3) (7/4)))
           (s2 'set :root '(7/8) 
              :pitch-seq '((9/8) (8/7 2) (4/3) (7/6 2)))
           (s4 'set :root '(7/8)
             :pitch-seq '((1) (1/2) (9/4) (3/2 1/2) (9/7 7/4))) 
           (s7 'set :root '(7/8) 
              :pitch-seq  '((2) (7/4)))
           ; maybe?
           ;(s8 'set :root '(7/8) :base-ratio 1/1  :unmuted 1
           ;   :pitch-seq    '((3/2) (9/8)))               ;1  
           )
  
  ; bring in s3, maybe slow fade in of s8?
  :33-1  ((post "33 A: s1 to 5, s7 to 3 ")
           (s1 'set :root '(1) :base-ratio 1/1 :pitch-change :seq
              :change-seq '(1  1  0  1  1  0  1)  
              :pitch-seq '((1) (4/3) (8/7) (7/6) (7/4)))
           (s2 'set :root '(1) :base-ratio 1/1      
              :pitch-seq '((9/8) (2) (7/6) (8/7)))
           (s3 'set :unmuted 1
             :root '(1)   :pitch-seq '((7/8) (7/6) (9/7 7/4) (4/3) (3/2 2/2)))
           (s4 'set :root '(1) :base-ratio 1/1    ;  
              :amp-seq      '(3   0   1   2   0) 
              :pitch-seq    '((1/2) (1/1) (7/4 1/2) (4/3 1/2) (9/7 7/4 1/2))) 
           (s7 'set :root '(1) :base-ratio 1/1  :unmuted 1
  ...
  :37-1  ((post "37 B")
           ...
           (s2 'set :root '(7/8) 
              :pitch-seq '((9/8) (8/7 2) (4/3) (7/6 2)))
           (s3 'set :root '(7/8) 
              :pitch-seq '((4/3) (7/6) (9/7 7/4) (4/3) (12/7 2/2)))
           (s4 'set :root '(7/8)
             :pitch-seq '((1) (1/2) (9/4) (3/2 1/2) (9/7 7/4))) 
           (s7 'set :root '(7/8) 
              :pitch-seq  '((2) (7/4) (9/8)))
  ...
  ; extends
  ; TODO change to s3? drop out s1?
  :41-1  ((post "41 A, s2 to 5 notes")
           (s1 'set :root '(1) :base-ratio 1/1 :pitch-change :seq
              :change-seq '(1  1  0  1  1  0  1)  
              :pitch-seq '((1) (4/3) (8/7) (7/6) (7/4)))
           (s2 'set :root '(1) :base-ratio 1/1      
