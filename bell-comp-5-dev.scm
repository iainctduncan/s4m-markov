...
; could pop up an octave at some point
(s2 'set :step-dur 160  :amp 0.0 :amp-unit 0.1 :delay 160 :pitch-change :all :base-ratio 2/1  
  ...
  :pitch-seq    '((9/7 7/4 1/2) (2) (7/6) (8/7) (7/4) (3/2))  ; six beat line
)
...
(s4 'set :step-dur 160  :amp 0.0 :amp-unit 0.2 :pitch-change :all  :base-ratio 1/1
  :beat-seq     #(3   2   3   2   2)
  :amp-seq      '(3   0   0   0   0) 
  :root         '(1)
  ;:pitch-seq    '((1/1) (1/2) (7/4) (4/3 1/2) (9/7 7/4)) 
  :pitch-seq    '((1/1) (1/2) (7/4 1/2) (4/3 1/2) (9/7 7/4 1/2)) 
  :pitch-seq    '((1/2) (1/1) (7/4 1/2) (4/3 1/2) (9/7 7/4 1/2)) 
)

; making this one short simple
(s5 'set :step-dur 160 :dur 30 :amp 0.0 :amp-unit 0.2  :delay 160 :pitch-change :seq  :base-ratio 2/1
  :beat-seq     #(1   3   1   1   3)
...
(s6 'set :step-dur 160 :amp 0.1 :amp-unit 0.1 :delay 0 :pitch-change :all  :base-ratio 2/1
  ...
  :amp-seq    '(3 2 3 2)
  :root         '(1)
  :pitch-seq    '((7/4 1/1) (4/3) (1/1) (3/2 1/2))
)

; good, could be octave 1 or 2, I think 2? maybe use both, lower is nice with 1 and 2
(s7 'set :step-dur 160  :amp 0.1 :amp-unit 0.2  :pitch-change :all :ref-cps 110 :base-ratio 1/1
  :beat-seq     #(1 2 1 1 1 2)  ; 1280 ticks total, 2/3s a 12/8 bar
  ;:beat-seq     #(1 2 1 1 2) ; more cut up
  :amp-seq      '(1 1 1 1)
  :root         '(1)
  :pitch-seq    '((1) (7/6) (7/4) (3/2) (8/7) (4/3))
  ; I think it's more interesting when it starts on a five
  :pitch-seq    '((1) (7/6) (7/4) (3/2) (8/7))
  ;:pitch-seq    '((1) (7/6) (7/4) (3/2)  (1) (7/6) (8/7) (4/3))
)

(s8 'set :step-dur 160  :amp 0.1 :amp-unit 0.2  :delay 80 :pitch-change :all :ref-cps 110  :base-ratio 2/1
  ;:beat-seq     #(3   2   3   2   2)
  :beat-seq     #(2   1   2   2   1)
  :change-seq   #(1   1   0   1  0 )
  :amp-seq      '(1 1 1 1)
  :root         '(1)
  ;:pitch-seq    '((1) (7/6) (4/3) (7/4) (3/2))
  :pitch-seq    '((1) (7/6) (4/3) (7/4) (3/2))
)
